...
export const Zephyr: IProject = {
  ...
  "description": [
    "<em>Odyssey of the Zephyr</em> is an RPG in which your goal is to bring happiness to each car along a train. It was created on Train Jam 2018 with a team of four developers."
  ],
  "type": "Game Jam",
...
export const BugHunters: IProject = {
  ...
  "description": [
    "<em>BugHunters 2</em> is the sequel to the wildly-popular (yet never-released) game <em>BugHunters</em>. It was created in the Introduction to Virtual Reality topics course at the University of Iowa in 2018. The team was composed of one art student and two computer science students."
  ],
...
export const RobotEyebrows: IProject = {
  ...
  "description": [
    ...
    "One of the leading robots in the field of robot-human interaction is the NAO robot, so we decided to build off of <a href='https://link.springer.com/article/10.1007/s12369-016-0363-x' target='_blank' rel='noopener noreferrer'> a previously proposed model for pluggable eyebrows</a> for these robots. In this study, we analyzed if the inclusion of pluggable eyebrows on the NAO robot will assist with its ability to convey different emotional expressions.",
